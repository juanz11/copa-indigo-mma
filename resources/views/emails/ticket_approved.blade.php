...
<head>
    ...
    <style>
        ...
        .body { padding: 2rem; color: #D4AF37; }
        p { color: #D4AF37; }
...
<body style="color:#D4AF37;">
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p style="color:#D4AF37;">Hola <strong>{{ $registration->full_name }}</strong>,</p>
            <p style="color:#D4AF37;">Tu pago fue verificado y tu entrada para la <strong>Copa Índigo MMA</strong> está confirmada.</p>
            ...
            <p style="color:#D4AF37;">Presenta este código QR en la entrada. También puedes abrir tu boleto digital aquí:</p>
            <div class="qr-wrap">
